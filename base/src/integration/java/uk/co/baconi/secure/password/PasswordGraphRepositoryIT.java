...
import uk.co.baconi.secure.IntegrationTestConfiguration;
import uk.co.baconi.secure.bag.Bag;
import uk.co.baconi.secure.bag.BagGraphRepository;
...
@ContextConfiguration(classes = IntegrationTestConfiguration.class, loader = AnnotationConfigContextLoader.class)
