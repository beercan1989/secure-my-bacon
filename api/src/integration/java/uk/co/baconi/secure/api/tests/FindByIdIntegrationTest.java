...
public interface FindByIdIntegrationTest extends RestApiAuthentication {

    String endpoint();

    void onFindById();

    default void onFindByIdImpl(final int id, final String name) {

        // Found
        withNoAuthentication().
                get("{base}/by-id/{id}", endpoint(), id).
        ...
        // Not Found
        withNoAuthentication().
                get("{base}/by-id/{id}", endpoint(), Long.MAX_VALUE).
